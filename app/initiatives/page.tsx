...
import djtal from "@/assets/images/DJTAL.jpg";
    ...
    <main className="flex flex-col justify-start px-2 w-full text-xs leading-[115%] pt-[calc(var(--nav-height)*1.2)] pb-2">
      <div className="grid grid-cols-18 gap-2 flex-1 min-h-0">
        ...
        <div className="col-start-7 col-span-12 grid grid-cols-12 gap-x-2 gap-y-[var(--nav-gap)] h-fit">
          <article className="flex flex-col col-span-12 justify-start gap-8">
            <div className="flex flex-col">
              <Image src={gia} alt="GIA" className="w-full h-auto pb-2" />
              <h2 className="uppercase">Gia</h2>
              <p className="opacity-70">Grants, written and indexed</p>
              <p className="pt-2">
                A grant writing tool and a searchable index — built to help
                people find the funding they need and ask for it well.
              </p>
            </div>
            <a
          ...
          <article className="flex flex-col justify-start col-span-12 gap-8">
            <div className="flex flex-col">
              <Image src={djtal} alt="DJTAL" className="w-full h-auto pb-2" />
              <h2 className="uppercase">DJTAL</h2>
              <p className="opacity-70">An affordable DJ studio</p>
              <p className="pt-2">
                A place to practice and learn — turntables, open hours, and
                mentorship, at a price that doesn&apos;t gate the craft.
              </p>
            </div>
            <a
              href="https://djt.al"
          ...
          <article className="col-span-12 flex flex-col justify-start gap-8">
            <div className="flex flex-col">
              <Image src={gia} alt="GIA" className="w-full h-auto pb-2" />
              <h2 className="uppercase">Espace Septima</h2>
              <p className="opacity-70">Community space &amp; studio office</p>
              
              <p className="pt-2">
                Applied Archive&apos;s home base — and a room held open for
                non-profits and emerging creatives who need a place to work,
                meet, and build.
              </p>
            </div>
