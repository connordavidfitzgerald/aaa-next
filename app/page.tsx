...
export default function HomePage() {
    return (
        <main className="flex flex-col justify-start px-2 pb-8">
            <section
                id="video"
                className="h-fit pt-[var(--nav-height)] flex flex-col justify-center items-center"
            >
                <HomeHeroMux />
            </section>
            <section
            ...
            >
                <h3 className="text-md bg-green leading-[120%] px-1 pt-0.5">
            ...
            >
                <div className="flex flex-col gap-25">
                    {projects.map((project) => {
                        const heroMedia = flattenMedia(project.media).slice(0, 2);
                        return (
                            <Link
                                key={project.id}
                            ...
                            >
                                ...
                                {heroMedia.map((item, i) => (
                                    <div
                                        key={i}
                                        className={`col-span-18 ${colSpans[i]}`}
                                    >
